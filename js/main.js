...
btnSi.addEventListener('click', function () {
    Swal.fire({
        ...
        mensaje.textContent = '❤ ¡Adarleny eres la casualidad más bonita que me ha pasado! 🥰❤ De verdad Gracias por todo feliz cumpleaños te amo❤';
    });
});
